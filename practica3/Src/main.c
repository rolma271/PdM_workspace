...
#include "../API/Inc/API_delay.h"

/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
#define LED_PATTERN_PERIOD_200_MS	  	200
...
int main(void)
{
	...
	delayInit(&timer_LED1, LED_PATTERN_PERIOD_200_MS);
	...
	while (1)
	{
		if (delayRead(&timer_LED1))
		{
			...
			delayWrite(&timer_LED1,LED_PATTERN_PERIOD_200_MS);
		}
	}
}
